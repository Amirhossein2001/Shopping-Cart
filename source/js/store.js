let allProducts = [
    { id: 1, title: 'Album 1', price: 1, img: 'Images/Album 1.png', count: 1 },
    { id: 2, title: 'Album 2', price: 43, img: 'Images/Album 2.png', count: 1 },
    { id: 3, title: 'Album 3', price: 12, img: 'Images/Album 3.png', count: 1 },
    { id: 4, title: 'Album 4', price: 239, img: 'Images/Album 4.png', count: 1 },
    { id: 5, title: 'Coffee', price: 80, img: 'Images/Cofee.png', count: 1 },
    { id: 6, title: 'Shirt', price: 32, img: 'Images/Shirt.png', count: 1 },
];
...
function addProductToBasketArray(productId) {
    let existingProductIndex = userBasket.findIndex(function(product) {
        return product.id === productId;
    });

    if (existingProductIndex !== -1) {
        // Product already exists in the basket, update its count
        userBasket[existingProductIndex].count++;
    } else {
...
function removeProductFromBasket(productId) {
    ...
    basketProductsGenerator(userBasket);
    calcTotalPrice(userBasket); // Recalculate total price after product removal
}
